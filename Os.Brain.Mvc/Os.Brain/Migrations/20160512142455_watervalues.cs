...
{
    public partial class watervalues : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Wm_IdCard = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaterValue", x => x.Wv_Month);
                    table.UniqueConstraint("AK_WaterValue_Wm_IdCard", x => x.Wm_IdCard);
                    table.UniqueConstraint("AK_WaterValue_Wv_Year", x => x.Wv_Year);
                });
