...
namespace os.brain.Migrations
{
    ...
    [Migration("20160516083230_addwatervalueimport5")]
    partial class addwatervalueimport5
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Os.Brain.Models.TEST.Category", b =>
                {
                    ...
                    b.HasAnnotation("Relational:TableName", "zz_test_category");
                });

            modelBuilder.Entity("Os.Brain.Models.TEST.Product", b =>
                {
                    ...
                    b.HasAnnotation("Relational:TableName", "zz_test_product");
                });
            ...
            modelBuilder.Entity("Os.Brain.Models.TEST.Product", b =>
                {
                    b.HasOne("Os.Brain.Models.TEST.Category")
                        .WithMany()
