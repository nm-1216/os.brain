...
{
    public partial class addPayTime : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_WaterValue_WaterMeter_Wm_IdCard", table: "WaterValues");
            migrationBuilder.DropForeignKey(name: "FK_WaterValueImport_WaterMeter_Wm_IdCard", table: "WaterValueImports");
            ...
            migrationBuilder.AddForeignKey(
                ...
                onDelete: ReferentialAction.Cascade);
            migrationBuilder.AddForeignKey(
                name: "FK_WaterValue_WaterMeter_Wm_IdCard",
                table: "WaterValues",
                column: "Wm_IdCard",
                principalTable: "WaterMeters",
                principalColumn: "Wm_IdCard",
                onDelete: ReferentialAction.Cascade);
            migrationBuilder.AddForeignKey(
                name: "FK_WaterValueImport_WaterMeter_Wm_IdCard",
                table: "WaterValueImports",
                column: "Wm_IdCard",
                principalTable: "WaterMeters",
                principalColumn: "Wm_IdCard",
                onDelete: ReferentialAction.Cascade);
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_TrayInBinLocation_BinLocation_BinLocationId", table: "WmsTrayInBinLocations");
            migrationBuilder.DropForeignKey(name: "FK_TrayInBinLocation_Tray_TrayId", table: "WmsTrayInBinLocations");
            migrationBuilder.DropColumn(name: "IsPay", table: "WaterPayments");
            migrationBuilder.DropColumn(name: "PayTime", table: "WaterPayments");
            migrationBuilder.AddForeignKey(
                name: "FK_IdentityRoleClaim<string>_Role_RoleId",
                table: "AspNetRoleClaims",
                column: "RoleId",
