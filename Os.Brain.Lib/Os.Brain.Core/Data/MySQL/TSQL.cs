...
namespace Os.Brain.Data.MySQL
{
    ...
    /// common TSQL
    /// </summary>
    public partial class MySQL_TSQL
    {
        #region const
        ...
        /// </summary>
        public const string INSERT_VALUE_IDENTITY = "INSERT INTO {0} ({1}) VALUES ({2}); SELECT @@IDENTITY";
        ...
        /// 根据主键获取 数据
        /// </summary>
        public const string SELECT_ITEM = "SELECT * FROM {0} WHERE {1} = '{2}' LIMIT 0, 1";
        ...
        /// </summary>
        public const string DELETE_LIST = "DELETE FROM {0} WHERE {1} IN ({2})";
